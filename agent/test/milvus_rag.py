...
# ==============================================================================
def main():
    parser = argparse.ArgumentParser(description="Milvus 产品文档向量库：入库 / 检索")
    parser.add_argument("--ingest", action="store_true",
                        help="将 mock_data/ 下的 Markdown 文档分块灌入 Milvus（会覆盖同名 Collection）")
    parser.add_argument("--data-dir", default=None,
                        help="文档目录，默认 <repo>/mock_data")
    parser.add_argument("--query", default="五天无理由退款有什么限制条件吗？",
                        help="检索测试问题，仅在未指定 --ingest 时生效")
